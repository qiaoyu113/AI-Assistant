...
export function GetVehicleBrandList(data) {
  return request({
    url: '/vehicle/v3/vehicle/getVehicleBrandList',
    method: 'post',
    data
  })
}
...
// 查询车辆型号
export function GetVehicleTypeByBrandId(data) {
  return request({
    url: '/vehicle/v3/vehicle/getVehicleTypeByBrandId',
    method: 'post',
    data
  })
}
...
// 查询所属单位
export function GetMgrOrgListByCurrentUser(data) {
  return request({
    url: `${baseCenterUrl}/v3/base/office/list/getMgrOrgListByCurrentUser`,
    method: 'get',
    data
  })
}
...
export const GetWarehouseList = () =>
  request({
    url: '/vehicle/v3/warehouse/getWarehouseList',
    method: 'post'
  })

// 获取仓库地址"type":1 仓库,"type":2 维修站
export const getWarehouseListByType = (data) =>
  request({
    url: '/vehicle/v3/warehouse/getWarehouseListByType',
    method: 'post',
    data
  })
